...
class ResourceList(RetrieveModelMixin, ListModelMixin, CreateModelMixin, viewsets.GenericViewSet):
    ...
    def in_tile(self, request, zoom_level, x, y):
        ...
        resources = Resource.objects.filter(location__within=boundary_wkt)
